<?php
    ...
    class task extends Model{
        ...
        public static function create($task){
            ...
            $query = "
                        INSERT INTO $table (id, project_id, stage_id,member_id,short_description,detail) values (null, '$task->id', '$task->project_id', '$task->stage_id','$task->member_id','$task->short_description','$task->detail');
                    ";
            $db = new DBConnection();
            $conn = $db->getConnection();
            $results = $conn->query($query);
